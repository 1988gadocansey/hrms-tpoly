...
@endif
 ...
 <h5>Students owing and payment reports</h5>  
 <div style="">
                ...
                <form action="{!!    url('owing_paid')  !!}"  method="get" accept-charset="utf-8" novalidate id="group">
                   {!!  csrf_field()  !!}
                    <div class="uk-grid" data-uk-grid-margin="">
                       ...
                       <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('type', array('owing'=>'owing','paid'=>'paid'), null, ['placeholder' => 'select type','id'=>'parent','class'=>'md-input parent'],old("type","")); !!}
                         </div>
                        </div>
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('season', array('Evening'=>'Evening','Regular'=>'Regular','Weekend'=>'Weekend'), null, ['placeholder' => 'select season','id'=>'parent','class'=>'md-input parent'], old("type","")); !!}
                         </div>
                        </div>
