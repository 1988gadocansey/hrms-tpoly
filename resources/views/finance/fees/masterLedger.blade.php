                ...
                <form action="{!!    url('view_payments_master')  !!}"  method="get" accept-charset="utf-8" novalidate id="group">
                   {!!  csrf_field()  !!}
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('level', array('50'=>'50','100'=>'100','200' => '200', '300' => '300','400'=>'400'), null, ['placeholder' => 'select level','id'=>'parent','class'=>'md-input parent'],old("level","")); !!}
                         </div>
                        </div>
                       <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">                                                        
                             <input type="text"  style="" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{ old("from_date") }}" name="from_date" id="invoice_dp" class="md-input" placeholder="date from ">
                             </div>
                         </div>

                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">                            
                            <input type="text" style="" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="{{ old("to_date") }}" name="to_date"  class="md-input" placeholder="date to">
                            </div>
                        </div>
                        
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('type', array('Part payment'=>'Part payment','Full payment'=>'Full payment'), null, ['placeholder' => 'select payment type','id'=>'parent','class'=>'md-input parent'], old("type","")); !!}
                         </div>
                        </div>
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                  {!!  Form::select('mode', array('PAY IN SLIP'=>'PAY IN SLIP','Cheque'=>'Cheque','Receipts'=>'Receipts','Cash'=>'Cash'), null, ['placeholder' => 'select payment mode','id'=>'parent','class'=>'md-input parent'], old("type","")); !!}
                         </div>
                        </div>
                         <div class="uk-width-medium-1-10" style=" ">
                            <div class="uk-margin-small-top">                            
                ...
                <table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter"> 
                                  <thead>
                                     ...
                                     <th>INDEXNO</th>
                                      ...
                                      <th>AMOUNT</th>
                                      <th>BANK DATE</th>
                                      <th  class="filter-false remove sorter-false uk-text-center" data-priority="1">ACTION</th>   
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="">
                                            ...
                                            <td> <img class="md-user-image-large" style="width:60px;height: auto" src='{{url("Albums/students/$row->INDEXNO.JPG")}} 'alt=" Picture of Student Here"    /></td>
                                              <td> {{ @$row->INDEXNO }}</td>
                                            ...
                                            <td>  <a href='{{url("edit_student/$row->INDEXNO/id")}}' ><i title='Click to view payment history' class="md-icon material-icons">&#xE88F;</i></a></td>
