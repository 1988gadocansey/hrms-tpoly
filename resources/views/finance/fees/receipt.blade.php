        ...
        <tr>
          <td   style="border:dashed; text-align: left;"><table width="738" height="451" border="0" cellspacing="1">
                    ...
                    <tr>
                      ...
                      <td width="722"><div align="center" >
                        ...
                        <span class="uk-text-bold uk-margin-top-remove">{!! $transaction->FEE_TYPE !!}  Receipt
                              ...
                              <P></P>
                              <span class="uk-text-bold">Total Fees GHC{!! $transaction->student->BILLS!!}</span>
            ...
            <tr>
              ...
              <td colspan="3" style=" border-bottom-style:dotted">{!! $transaction->bank->NAME!!}</td>
            </tr>
            <tr>
              <td><strong> Transaction ID</strong></td>
              <td colspan="3" style=" border-bottom-style:dotted"><strong>{!! $transaction->TRANSACTION_ID!!}</strong></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3" style="border-bottom-style:dotted"><strong>GHC{!! $transaction->student->BILL_OWING !!}
                     .00</strong></td>
            </tr>
            <tr>
