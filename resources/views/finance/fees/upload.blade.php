...
@endif
 ...
 <div align="center">
     <form method="POST" action="{{ url('upload_fees') }}"  enctype="multipart/form-data"  accept-charset="utf-8"  name="applicationForm"  v-form>
                 ...
                 <div class="md-card">
                     <div class="md-card-content">
                         <h3 class="heading_a uk-margin-small-bottom">
                            Upload fees file here  Max size (2MB)
                         </h3>
         ...
         <p>click to download fee template(PLEASE ADHERE TO THE TEMPLATE)<a href='{{url("uploads/fees/fee-sample.csv")}}'>click download template</a></p>
     </form>
 </div>
