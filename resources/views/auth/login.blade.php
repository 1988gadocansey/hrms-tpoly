    ...
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row">
          <div class="input-field col s12 center">
              <img src="assets/img/logo.png" alt="" class="" style="width:90px;height:100px">
            <p class="center login-form-text">Hospital Records Management System
<br/>Takoradi Polytechnic
            </p>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="username" class="center-align">Polytechnic Email</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
          ...
          <div class="input-field col s12">
              <table>
                  <tr>
                      ...
                      <td><button type="submit" class="btn waves-effect waves-effect col s12">  Learn about HRMS</button></td>
                  </tr>
              </table>
          </div>
        </div>
